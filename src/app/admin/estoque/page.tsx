        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6">
          <div className="flex justify-between items-center h-16 sm:h-20">
            ...
            <nav className="hidden md:flex items-center gap-1 ml-6">
                ...
                <Link href="/admin/estoque" className="px-4 py-2 bg-brand-cyan/5 text-brand-cyan rounded-lg text-xs font-bold transition-all">Estoque</Link>
      ...
      <main className="max-w-7xl mx-auto px-4 sm:px-6 pt-10">
        ...
        {loading ? (
          <div className="py-20 flex flex-col items-center gap-4">
            ...
            <p className="text-xs font-bold text-text-dark/30 uppercase tracking-widest">Calculando saldos...</p>
          </div>
        ) : error ? (
